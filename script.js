  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          return (field.dataset.errorMaxlength || 'Please enter no more than {max} characters.').replace('{max}', max);
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7b9b60fe-ee90-47d6-b150-dfe08e020427',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7b9b60fe-ee90-47d6-b150-dfe08e020427';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7b9b60fe-ee90-47d6-b150-dfe08e020427';
